...
"startposition": new Anno({ 
  ...
  content: '<?php _e("This setting will determine the center of the map when it is first displayed. <br/><br/> You can set it manually (Format : <i>latitude</i>,<i>longitude</i>), or just drag the preview map to the desired point","locate-and-filter")?>'
}),
"maxzoom": new Anno({ 
  target : '#maxzoom',
  content: '<?php _e("This setting will determine the maximum zoom allowed for this map.","locate-and-filter")?>'
}),
"minzoom": new Anno({ 
  target : '#minzoom',
  content: '<?php _e("This setting will determine the minimum zoom allowed for this map.","locate-and-filter")?>'
}),
"startzoom": new Anno({ 
  target : '#startzoom',
...
"nice-tooltips-settings": new Anno({ 
  ...
  content: '<?php _e("Select the \"Nice Tooltips\" setting in the dropdown menu. You can set the maximum image height or just leave it blank.","locate-and-filter")?>'
}),

"medialibrary": new Anno({ 
  target : '#medialibrary',
  content: '<?php _e("You can use an image from Wordpress media library as a marker icon. <br><b>Warning</b> : The image will NOT be resized. Please make sure its size is adequate.","locate-and-filter")?>'
}),

"display_only_inbound": new Anno({ 
  target : '#display_only_inbound',
  content: '<?php _e("If this option is checked the navlist will only show the markers that are located in the bounds of the map. This means that for example if your map is zoomed and centered on NYC and your markers are in SF, the navlist will be empty","locate-and-filter")?>'
}),
